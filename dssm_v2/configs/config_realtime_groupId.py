...
config_realtime = {
    ...
    "item_news_category1": {
        ...
        "value_type": "string",
        "feature_index": 13,
        "index_name": "CATEGORY",  # need to split
    },
    "item_news_category2": {
...
def format_features(input_fea_str, fea_len, split_index, default_val=feature_id_padding):
